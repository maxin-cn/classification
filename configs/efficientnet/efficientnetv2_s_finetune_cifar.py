_base_ = [
    '../_base_/models/efficientnet/tf_efficientnetv2_s.py', 
...
model = dict(
    backbone=dict(
        init_cfg=dict(
            type='Pretrained',
            checkpoint='https://s3plus.sankuai.com/v1/mss_9240d97c6bf34ab1b78859c3c2a2a3e4/automl-model-zoo/models/efficientnet/tf_efficientnetv2_s-eb54923e.pth',
        )),
