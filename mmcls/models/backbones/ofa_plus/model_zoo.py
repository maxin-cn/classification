...
from .layers import MyModule, set_layer_from_config, ResNetBottleneckBlock
from .utils import MyNetwork

class ResNetSS(MyNetwork):

	BASE_DEPTH_LIST = [1, 2, 4, 1]
	...
	def build_from_config(config):
		...
		net = ResNetSS(input_stem, blocks, classifier)
		if 'bn' in config:
	...
	def load_state_dict(self, state_dict, **kwargs):
		super(ResNetSS, self).load_state_dict(state_dict)
