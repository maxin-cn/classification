...
import logging
import torch
from SKDX.compression.utils.mask_conflict import fix_mask_conflict
from SKDX.compression.utils.utils import get_module_by_name
from SKDX.compression.speedup.compress_modules import replace_module
from SKDX.compression.speedup.infer_shape import ModuleMasks, infer_from_mask, infer_from_inshape, infer_from_outshape, set_conv_prune_dim
...
class ModelSpeedup:
    ...
    def __init__(self, model, dummy_input, masks_file, map_location=None):
        ...
        """
        from SKDX.common.graph_utils import build_module_graph
