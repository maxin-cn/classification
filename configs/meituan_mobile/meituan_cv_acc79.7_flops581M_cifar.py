...
model = dict(
    backbone=dict(type='MeituanMobile',
                  ...
                  init_cfg=dict(
                        type='Pretrained',
                        checkpoint='https://s3plus.sankuai.com/v1/mss_9240d97c6bf34ab1b78859c3c2a2a3e4/automl-model-zoo/openmmlab/net_pretrained/meituan_cv_acc79.7_flops581M.pth',
                  )),
