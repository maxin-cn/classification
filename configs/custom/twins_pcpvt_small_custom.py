_base_ = [
    '../_base_/models/twins/twins_pcpvt_small.py',
...
model = dict(
    backbone=dict(
        init_cfg=dict(
            type='Pretrained',
            checkpoint='https://s3plus.sankuai.com/v1/mss_9240d97c6bf34ab1b78859c3c2a2a3e4/automl-model-zoo/openmmlab/twins/twins_pcpvt_small-e70e7e7a.pth',
        )),
