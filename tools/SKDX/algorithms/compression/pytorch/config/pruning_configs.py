...
def amc_configs_func():
    config_list = {}
    config_list['layer_types']  = ['Conv2d', 'Linear']
    config_list['episode']      = 800
    config_list['sparse_ratio'] = 0.7
    config_list['lower_bound']  = 0.5
    config_list['upper_bound']  = 0.9
    config_list['suffix']       = None
