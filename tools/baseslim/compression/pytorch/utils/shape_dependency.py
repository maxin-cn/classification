...
import torch
import numpy as np
from baseslim.compression.pytorch.compressor import PrunerModuleWrapper
from baseslim.algorithms.compression.v2.pytorch.base import PrunerModuleWrapper as PrunerModuleWrapper_v2
...
class Dependency:
    def __init__(self, model=None, dummy_input=None, traced_model=None):
        ...
        """
        from baseslim.common.graph_utils import TorchModuleGraph
