...
from baseslim.compression.pytorch.compressor import Quantizer, QuantForward
from baseslim.compression.pytorch.quantization.observers import default_weight_observer, default_histogram_observer
