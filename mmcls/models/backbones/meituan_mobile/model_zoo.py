...
class MobileNetV3SS(MyNetwork):
    ...
    def build_from_config(config):
        ...
        net = MobileNetV3SS(first_conv, blocks, final_expand_layer, feature_mix_layer, classifier)
        if 'bn' in config:
