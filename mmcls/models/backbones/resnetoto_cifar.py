...
class ResNetOTOCifar(BaseBackbone):

    def __init__(self, block=BottleNeck, num_block=[3, 4, 6, 3], num_classes=10, cfg=None):
        super().__init__()
    ...
    def prune(self):
        ...
        prune_model = ResNetOTOCifar(BottleNeck, [3, 4, 6, 3], cfg=prune_config)
