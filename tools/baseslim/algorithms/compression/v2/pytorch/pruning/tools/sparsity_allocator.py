...
from baseslim.algorithms.compression.v2.pytorch.base import Pruner
from baseslim.compression.pytorch.utils.shape_dependency import ChannelDependency, GroupDependency
