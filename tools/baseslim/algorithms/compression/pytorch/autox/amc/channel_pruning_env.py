...
from SKDX.compression.compressor import PrunerModuleWrapper
from SKDX.algorithms.compression.pytorch.pruning.structured_pruning import AMCWeightMasker
...
class ChannelPruningEnv:
    ...
    def __init__(self, pruner, evaluator, val_loader, checkpoint, args):
        ...
        print('=> original FLOPs: %.4f M' % (self.org_flops * 1. / 1e6))
